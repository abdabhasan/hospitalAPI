...
namespace HospitalDataLayer.Infrastructure
{
    public class clsInsuranceClaimData : IInsuranceClaimData
    {
        ...
        public async Task<InsuranceClaimDTO> GetInsuranceClaimsForPatientByPatientIdAsync(int patinetId)
        {
            throw new NotImplementedException();
        }

        public async Task<InsuranceClaimDTO> GetInsuranceClaimsForPatientByPatientNameAsync(string patinetName)
        {
            throw new NotImplementedException();
        }
    }
